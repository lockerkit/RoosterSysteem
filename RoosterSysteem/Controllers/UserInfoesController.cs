...
namespace RoosterSysteem.Controllers
{
    ...
    {
        private ZuydDBEntities db = new ZuydDBEntities();
        ...
        {
            ViewBag.UserUserID = new SelectList(db.Users, "UserID", "UserName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,MailAddress,Faculty,Module,AvailableHours,UserUserID")] UserInfo userInfo)
        {
            ...
            ViewBag.UserUserID = new SelectList(db.Users, "UserID", "UserName", userInfo.UserUserID);
            return View(userInfo);
        }
